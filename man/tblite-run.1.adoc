...
*--post-processing* _file_|_name_::
     ...
     - lmo-<method> (localized molecular orbitals and centers, options: foster-boys)
...
*--trexio* [_file_]::
     ...
     Localized molecular orbitals are written in a file with a `-lmo` tag in the filename (e.g. tblite-lmo.trexio).

*--molden* [_file_]::
     Dump results as Molden output to _file_ (default: tblite.molden).
     Localized molecular orbitals are written in a file with a `-lmo` tag in the filename (e.g. tblite-lmo.molden).
