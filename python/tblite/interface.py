...
class Result:
    ...
    def get(self, attribute: str):
        ...
        ====================== ============================= ==============
         ...
         dipole                 3                             e·Bohr
         quadrupole             6                             e·Bohr²
         orbital-energies       norb or 2, norb               Hartree
         orbital-occupations    norb or 2, norb               e
         orbital-coefficients   norb, norb or 2, norb, norb   unitless
         overlap-matrix         norb, norb                    unitless
         hamiltonian-matrix     norb, norb                    Hartree
         density-matrix         norb, norb or 2, norb, norb   e
