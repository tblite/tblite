...
subroutine test_orbital_energy_ref(error)
   ...
   write(io, '(a)') &
      ...
      "ext_gap_beta = [ 9.4538889011103251, 9.4538889011103251, 6.5537012263493972 ]", &
      "ext_chem_pot_beta = [ -12.033203108919651, -12.033203108919651, -12.997992016339715 ]", &
      "ext_HOAO_beta = [ -16.760147559474841, -16.760147559474841, -16.274842629514470 ]", &
      "ext_LUAO_beta = [ -7.3062586583645421, -7.3062586583645421, -9.7211414031650794 ]", &
      ""
   rewind io
