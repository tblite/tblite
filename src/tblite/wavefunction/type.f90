...
module tblite_wavefunction_type
   ...
   public :: get_density_matrix, get_alpha_beta_occupation, occu
   ...
   type, public :: wavefunction_type
      ...
      !> Occupation numbers of alpha spin, shape: [nao, spin]
      real(wp), allocatable :: focca(:)
      !> Occupation numbers opf beta spin, shape: [nao, spin]
      real(wp), allocatable :: foccb(:)
      !> Index of HOMO in alpha spin
      integer :: ihomoa = 0
      !> Index of HOMO in beta spin
      integer :: ihomob = 0
